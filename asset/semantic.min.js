...
!function (e, t, n, i) {
        ...
        return a.each(function () {
            ...
            f = {
                initialize: function () {
                    ...
                    var n = t !== i ? "number" == typeof t ? C.eq(t) : e(t) : e(this), o = n.next(k), a = o.is(":visible");
                    ...
                    var n = t !== i ? "number" == typeof t ? C.eq(t) : e(t) : e(this), o = n.next(k), a = o.is(":animated"), r = o.hasClass(g.active);
                    a || r || (f.debug("Opening accordion content", n), m.exclusive && f.closeOthers.call(n), n.addClass(g.active), m.animateChildren && (e.fn.transition !== i && w.transition("is supported") ? o.children().transition({
                        ...
                        verbose: m.verbose,
                        duration: m.duration
                    }) : o.children().stop().animate({opacity: 1}, m.duration, f.resetOpacity)), o.stop().slideDown(m.duration, m.easing, function () {
                        o.addClass(g.active), f.reset.display.call(this), m.onOpen.call(this), m.onChange.call(this)
                    }))
                }, close: function (t) {
                    var n = t !== i ? "number" == typeof t ? C.eq(t) : e(t) : e(this), o = n.next(k), a = o.hasClass(g.active);
                    a && (f.debug("Closing accordion content", o), n.removeClass(g.active), o.removeClass(g.active).show(), m.animateChildren && (e.fn.transition !== i && w.transition("is supported") ? o.children().transition({
                        ...
                        verbose: m.verbose,
                        duration: m.duration
                    }) : o.children().stop().animate({opacity: 0}, m.duration, f.resetOpacity)), o.stop().slideUp(m.duration, m.easing, function () {
    ...
    e.fn.dropdown = function (o) {
        ...
        return r.each(function () {
            var p, v, h, b, y = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.dropdown.settings, o) : e.extend({}, e.fn.dropdown.settings), x = y.className, w = y.metadata, C = y.namespace, k = y.selector, T = y.error, S = "." + C, A = "module-" + C, P = e(this), E = P.find(k.text), F = P.find(k.search), R = P.find(k.input), O = P.prev().find(k.text).length > 0 ? P.prev().find(k.text) : P.prev(), D = P.children(k.menu), z = D.find(k.item), q = !1, j = !1, N = this, I = P.data(A);
            b = {
                initialize: function () {
                    ...
                    mousedown: function () {
                        ...
                        {
                            var t, n = z.not(x.filtered).filter("." + x.selected).eq(0), i = D.children("." + x.active).eq(0), o = n.length > 0 ? n : i, a = o.length > 0 ? o.siblings(":not(." + x.filtered + ")").andSelf() : D.children(":not(." + x.filtered + ")"), r = o.children(k.menu), s = o.closest(k.menu), c = s[0] !== D[0], l = s.is(":visible"), u = e.which, d = {
                                enter: 13,
                                escape: 27,
                                leftArrow: 37,
                                upArrow: 38,
                        ...
                        mouseenter: function (t) {
                            var n = e(this).children(k.menu), i = e(this).siblings(k.item).children(k.menu);
                            ...
                            var n = e(this), i = e(t ? t.target : ""), o = n.find(k.menu), a = b.get.choiceText(n), r = b.get.choiceValue(n, a), s = function () {
        ...
        return r.each(function () {
            ...
            T = {
                initialize: function () {
                    ...
                    t = e.isFunction(t) ? t : function () {
                    }, r.is(":visible") && (T.debug("Hiding all visible modals"), T.hideDimmer(), r.filter(":visible").modal("hide modal", t))
                }, hideOthers: function (t) {
                    t = e.isFunction(t) ? t : function () {
                    }, h.is(":visible") && (T.debug("Hiding other modals", h), h.filter(":visible").modal("hide modal", t))
    ...
    e.fn.popup = function (o) {
        ...
        return r.each(function () {
            var n, r, g, p = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.popup.settings, o) : e.extend({}, e.fn.popup.settings), v = p.selector, h = p.className, b = p.error, y = p.metadata, x = p.namespace, w = "." + p.namespace, C = "module-" + x, k = e(this), T = e(p.context), S = p.target ? e(p.target) : k, A = e(t), P = e("body"), E = 0, F = !1, R = this, O = k.data(C);
            g = {
                initialize: function () {
                    ...
                    g.verbose("Storing instance of module", g), O = g, k.data(C, O)
                }, refresh: function () {
                    ...
                    var t = k.data(y.html) || p.html, i = k.data(y.variation) || p.variation, o = k.data(y.title) || p.title, a = k.data(y.content) || k.attr("title") || p.content;
                    ...
                    t = e.isFunction(t) ? t : function () {
                    }, g.debug("Showing pop-up", p.transition), g.exists() ? p.preserve || p.popup || g.refresh() : g.create(), n && g.set.position() && (g.save.conditions(), g.animate.show(t))
                }, hide: function (t) {
                    t = e.isFunction(t) ? t : function () {
                    ...
                    conditions: function () {
                        g.cache = {title: k.attr("title")}, g.cache.title && k.removeAttr("title"), g.verbose("Saving original attributes", g.cache.title)
                    }
                }, restore: {
                    conditions: function () {
                    ...
                    show: function (t) {
                        t = e.isFunction(t) ? t : function () {
                        }, p.transition && e.fn.transition !== i && k.transition("is supported") ? (g.set.visible(), n.transition({
                        ...
                        t = e.isFunction(t) ? t : function () {
                        }, g.debug("Hiding pop-up"), p.transition && e.fn.transition !== i && k.transition("is supported") ? n.transition({
                    ...
                    startEvent: function () {
                        ...
                        var n = t !== i ? t[0] : k[0], o = n.parentNode, a = e(o);
                    ...
                    position: function (o, a) {
                        var s, c, l, u = (e(t).width(), e(t).height(), S.outerWidth()), d = S.outerHeight(), f = n.outerWidth(), m = n.outerHeight(), v = r.outerWidth(), x = r.outerHeight(), w = p.distanceAway, C = S[0], T = p.inline ? parseInt(t.getComputedStyle(C).getPropertyValue("margin-top"), 10) : 0, A = p.inline ? parseInt(t.getComputedStyle(C).getPropertyValue(g.is.rtl() ? "margin-right" : "margin-left"), 10) : 0, P = p.inline || p.popup ? S.position() : S.offset();
                        switch (o = o || k.data(y.position) || p.position, a = a || k.data(y.offset) || p.offset, E == p.maxSearchDepth && p.lastResort && (g.debug("Using last resort position to display", p.lastResort), o = p.lastResort), p.inline && (g.debug("Adding targets margin to calculation"), "left center" == o || "right center" == o ? (a += T, w += -A) : "top left" == o || "top center" == o || "top right" == o ? (a += A, w -= T) : (a += A, w += T)), g.debug("Calculating popup positioning", o), s = o, g.is.rtl() && (s = s.replace(/left|right/g, function (e) {
                            ...
                            case"top left":
                                c = {top: "auto", bottom: x - P.top + w, left: P.left + a, right: "auto"};
                                break;
                            case"top center":
                                c = {
                                    bottom: x - P.top + w,
                                ...
                                break;
                            case"top right":
                                c = {bottom: x - P.top + w, right: v - P.left - u - a, top: "auto", left: "auto"};
                                break;
                            case"left center":
                                c = {
                                    top: P.top + d / 2 - m / 2 + a,
                            ...
                            case"right center":
                                ...
                                break;
                            case"bottom left":
                                c = {top: P.top + d + w, left: P.left + a, bottom: "auto", right: "auto"};
                                break;
                            case"bottom center":
                                c = {
                                    top: P.top + d + w,
                                ...
                                break;
                            case"bottom right":
                                c = {top: P.top + d + w, right: v - P.left - u - a, left: "auto", bottom: "auto"}
                        }
            ...
            }, f ? (O === i && g.initialize(), g.invoke(d)) : (O !== i && O.invoke("destroy"), g.initialize())
        }), a !== i ? a : this
    }, e.fn.popup.settings = {
        name: "Popup",
        debug: !1,
            ...
            m = {
                initialize: function () {
                    ...
                    local: function (e) {
                        ...
                        m.set.loading(), m.save.results(n), m.debug("Returned local search results", n), t = m.generateResults({results: n}), m.remove.loading(), m.write.cachedHTML(e, t), m.addResults(t)
                    }, remote: function (t) {
                        var n = {
    ...
    e.fn.sticky = function (n) {
        var o, a = e(this), r = a.selector || "", s = (new Date).getTime(), c = [], l = arguments[0], u = "string" == typeof l, d = [].slice.call(arguments, 1);
        return a.each(function () {
            var a, f, m, g = e.extend(!0, {}, e.fn.sticky.settings, n), p = g.className, v = g.namespace, h = g.error, b = "." + v, y = "module-" + v, x = e(this), w = e(t), C = x.offsetParent(), k = e(g.scrollContext), T = (x.selector || "", x.data(y)), S = t.requestAnimationFrame || t.mozRequestAnimationFrame || t.webkitRequestAnimationFrame || t.msRequestAnimationFrame || function (e) {
                    setTimeout(e, 0)
                }, A = this;
            m = {
                initialize: function () {
                    return a = g.context ? e(g.context) : C, 0 === a.length ? void m.error(h.invalidContext, g.context, x) : (m.verbose("Initializing sticky", g, C), m.save.positions(), m.is.hidden() && m.error(h.visible, x), m.cache.element.height > m.cache.context.height ? (m.reset(), void m.error(h.elementSize, x)) : (w.on("resize" + b, m.event.resize), k.on("scroll" + b, m.event.scroll), g.observeChanges && m.observeChanges(), void m.instantiate()))
                }, instantiate: function () {
        ...
        return a.each(function (t) {
            ...
            k = {
                initialize: function () {
                    ...
                    conditions: function () {
                        return k.cache === i ? !1 : (k.cache.className ? T.attr("class", k.cache.className) : T.removeAttr("class"), k.cache.style && (k.verbose("Restoring original style attribute", k.cache.style), T.attr("style", k.cache.style)), k.is.looping() && k.remove.looping(), void k.verbose("Restoring original attributes", k.cache))
                    }
                }, add: {
                    failSafe: function () {
    ...
    e.fn.visibility = function (o) {
        var a, r = e(this), s = r.selector || "", c = (new Date).getTime(), l = [], u = arguments[0], d = "string" == typeof u, f = [].slice.call(arguments, 1);
        return r.each(function () {
            var r, m, g = e.extend(!0, {}, e.fn.visibility.settings, o), p = g.className, v = g.namespace, h = g.error, b = "." + v, y = "module-" + v, x = e(t), w = e(this), C = e(g.context), k = (w.offsetParent(), w.selector || "", w.data(y)), T = t.requestAnimationFrame || t.mozRequestAnimationFrame || t.webkitRequestAnimationFrame || t.msRequestAnimationFrame || function (e) {
                    setTimeout(e, 0)
                }, S = this;
            m = {
                initialize: function () {
                    m.verbose("Initializing visibility", g), m.setup.cache(), m.save.position(), m.should.trackChanges() && (m.bindEvents(), "image" == g.type && m.setup.image(), "fixed" == g.type && m.setup.fixed()), g.initialCheck && m.checkVisibility(), g.observeChanges && m.observeChanges(), m.instantiate()
                }, instantiate: function () {
                    m.verbose("Storing instance of module", m), k = m, w.data(y, m)
                }, destroy: function () {
                    m.verbose("Destroying previous module"), w.off(b).removeData(y)
                }, observeChanges: function () {
                    C[0];
                    ...
                    refresh: function () {
                        ...
                        m.verbose("Scroll position changed"), g.throttle ? (clearTimeout(m.timer), m.timer = setTimeout(m.checkVisibility, g.throttle)) : T(m.checkVisibility)
                    }
                    ...
                    trackChanges: function () {
                        return d && f.length > 0 ? (m.debug("One time query, no need to bind events"), !1) : (m.debug("Query is attaching callbacks, watching for changes with scroll"), !0)
                    }
                }, setup: {
                    cache: function () {
                        ...
                        var e = w.data("src");
                        e && (m.verbose("Lazy loading image", e), m.topVisible(function () {
                            m.debug("Image top visible", S), m.precache(e, function () {
                                m.set.image(e), g.onTopVisible = !1
                            })
                        }))
                    }, fixed: function () {
                        m.verbose("Setting up fixed on element pass"), w.visibility({
                            once: !1,
                            continuous: !1,
                    ...
                    visible: function () {
                        return m.cache && m.cache.element ? m.cache.element.height > 0 && m.cache.element.width > 0 : !1
                    }
                }, refresh: function () {
                    ...
                    m.verbose("Checking visibility of element", m.cache.element), m.save.calculations(), m.is.visible() && (m.passed(), m.passingReverse(), m.topVisibleReverse(), m.bottomVisibleReverse(), m.topPassedReverse(), m.bottomPassedReverse(), m.passing(), m.topVisible(), m.bottomVisible(), m.topPassed(), m.bottomPassed())
                }, passed: function (t, n) {
                    ...
                    calculations: function () {
                        ...
                        return m.verbose("Saving element position"), e.margin = {}, e.margin.top = parseInt(w.css("margin-top"), 10), e.margin.bottom = parseInt(w.css("margin-bottom"), 10), e.fits = e.height < t.height, e.offset = w.offset(), e.width = w.outerWidth(), e.height = w.outerHeight(), m.cache.element = e, e
                    }, elementCalculations: function () {
                        var e = m.get.screenCalculations(), t = m.get.elementPosition();
                        return g.includeMargin ? (t.top = t.offset.top - t.margin.top, t.bottom = t.offset.top + t.height + t.margin.bottom) : (t.top = t.offset.top, t.bottom = t.offset.top + t.height), t.topVisible = e.bottom >= t.top, t.topPassed = e.top >= t.top, t.bottomVisible = e.bottom >= t.bottom, t.bottomPassed = e.top >= t.bottom, t.pixelsPassed = 0, t.percentagePassed = 0, t.visible = t.topVisible || t.bottomVisible, t.passing = t.topPassed && !t.bottomPassed, t.hidden = !t.topVisible && !t.bottomVisible, t.passing && (t.pixelsPassed = e.top - t.top, t.percentagePassed = (e.top - t.top) / t.height), m.cache.element = t, m.verbose("Updated element calculations", t), t
                    }, screenCalculations: function () {
                        var t = C.scrollTop() + g.offset;
                        return m.cache.scroll === i && (m.cache.scroll = C.scrollTop() + g.offset), m.save.direction(), e.extend(m.cache.screen, {
                            top: t,
                            bottom: t + m.cache.screen.height
                        }), m.cache.screen
                    }, screenSize: function () {
